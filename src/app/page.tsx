    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
          ...
          <div className="container max-w-7xl mx-auto px-4 md:px-0">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
              <div className="flex flex-col items-center text-center p-2">
                ...
                <h3 className="font-medium text-sm md:text-base">Government Authorized</h3>
              ...
              <div className="flex flex-col items-center text-center p-2">
                ...
                <h3 className="font-medium text-sm md:text-base">50,000+ Happy Clients</h3>
              ...
              <div className="flex flex-col items-center text-center p-2">
                ...
                <h3 className="font-medium text-sm md:text-base">98% Success Rate</h3>
                <p className="text-xs md:text-sm text-gray-500">High visa approval rate</p>
              </div>
              <div className="flex flex-col items-center text-center p-2">
                <div className="bg-amber-50 p-2 md:p-3 rounded-full mb-2 md:mb-3">
                  <Clock className="h-5 w-5 md:h-6 md:w-6 text-amber-600" />
                </div>
                <h3 className="font-medium text-sm md:text-base">Express Processing</h3>
                <p className="text-xs md:text-sm text-gray-500">As fast as 24 hours</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              ...
              <Card className="overflow-hidden border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <CardContent className="p-4 md:p-6">
                  <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-3">Tourist Visa</h3>
              ...
              <Card className="overflow-hidden border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <CardContent className="p-4 md:p-6">
                  <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-3">Business Visa</h3>
                  <p className="text-gray-600 mb-4 text-sm md:text-base">
              ...
              <Card className="overflow-hidden border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <CardContent className="p-4 md:p-6">
                  <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-3">Passport Services</h3>
                  <p className="text-gray-600 mb-4 text-sm md:text-base">
          ...
          <div className="container max-w-7xl mx-auto px-4 md:px-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="relative flex flex-col items-center text-center">
                ...
                <h3 className="text-lg md:text-xl font-bold mb-2">Apply Online</h3>
              ...
              <div className="relative flex flex-col items-center text-center">
                ...
                <h3 className="text-lg md:text-xl font-bold mb-2">Expert Review</h3>
                <p className="text-sm md:text-base text-gray-600">
              ...
              <div className="relative flex flex-col items-center text-center">
                ...
                <h3 className="text-lg md:text-xl font-bold mb-2">Receive Your Visa</h3>
                <p className="text-sm md:text-base text-gray-600">
        ...
        <section className="py-12 md:py-16 bg-gray-900 text-white">
          <div className="container max-w-7xl mx-auto px-4 md:px-0">
            <div className="text-center mb-8 md:mb-12">
              <h2 className="text-2xl md:text-3xl font-bold mb-3 md:mb-4">Security & Compliance</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
              <div className="bg-gray-800 p-4 md:p-6 rounded-lg text-center">
                ...
                <h3 className="text-lg md:text-xl font-bold mb-2">Data Encryption</h3>
              ...
              <div className="bg-gray-800 p-4 md:p-6 rounded-lg text-center">
                ...
                <h3 className="text-lg md:text-xl font-bold mb-2">Compliance Certified</h3>
                <p className="text-sm md:text-base text-gray-300">
       ...
       <section className="py-12 md:py-20 bg-white">
          <div className="container px-4 mx-auto">
            ...
            <Tabs defaultValue="usa" className="w-full max-w-4xl mx-auto">
              <TabsList className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 mb-6 md:mb-8 overflow-x-auto">
                <TabsTrigger value="usa" className="text-sm md:text-base py-2">USA</TabsTrigger>
                <TabsTrigger value="uk" className="text-sm md:text-base py-2">UK</TabsTrigger>
                <TabsTrigger value="schengen" className="text-sm md:text-base py-2">Schengen</TabsTrigger>
                <TabsTrigger value="canada" className="text-sm md:text-base py-2">Canada</TabsTrigger>
                <TabsTrigger value="australia" className="text-sm md:text-base py-2">Australia</TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="usa" className="border rounded-lg p-4 md:p-6">
                ...
                <div className="mt-4 md:mt-6">
                  <Button className="bg-yellow-400 hover:bg-yellow-700 text-sm md:text-base py-2" asChild>
              ...
              <TabsContent value="uk" className="border rounded-lg p-4 md:p-6">
                <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4">UK Visa Requirements</h3>
                <ul className="space-y-2 md:space-y-3 text-sm md:text-base">
                  <li className="flex items-start">
                    <CheckCircle className="h-4 w-4 md:h-5 md:w-5 text-green-600 mr-2 mt-0.5 flex-shrink-0" />
              ...
              <TabsContent value="schengen" className="border rounded-lg p-4 md:p-6">
                <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4">
              ...
              {/* Canada Tab Content */}
              <TabsContent value="canada" className="border rounded-lg p-4 md:p-6">
                <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4">
              ...
              <TabsContent value="australia" className="border rounded-lg p-4 md:p-6">
                <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4">
        ...
        {/* Testimonials */}
        <section id="testimonials" className="py-12 md:py-20 bg-gray-900 text-white">
              ...
              <Card className="bg-gray-800 border-0 text-white">
                <CardContent className="p-6 md:p-8">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-sm md:text-base">Rahul Agarwal</h4>
              ...
              <Card className="bg-gray-800 border-0 text-white">
                <CardContent className="p-6 md:p-8">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-sm md:text-base">Sanjana Patel</h4>
                      <p className="text-gray-400 text-xs md:text-sm">
              ...
              <Card className="bg-gray-800 border-0 text-white">
                <CardContent className="p-6 md:p-8">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-sm md:text-base">Vikram Kumar</h4>
                      <p className="text-gray-400 text-xs md:text-sm">CEO, Bangalore</p>
                    </div>
                  </div>
                  <div className="flex mb-3 md:mb-4">
                    <Star className="h-4 w-4 md:h-5 md:w-5 fill-yellow-500 text-yellow-500" />
      ...
      <div className="bg-gray-50 p-4 md:p-8 rounded-xl shadow-lg">
        ...
        <form className="space-y-3 md:space-y-4">
          ...
          <div className="space-y-1 md:space-y-2">
            ...
            <Select>
              <SelectTrigger id="service" className="w-full py-1.5 md:py-2">
